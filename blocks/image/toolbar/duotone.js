...
const DuotonePanel = ({ props }) => {
    ...
    const [ isColorPickerDragding, setIsShowColorPickerDragging] = useState(false);
    ...
    function handleShadowPanel(status) {
        if (status === true){
            setShowColorPicker(true);
        } else if (status == null && showColorPicker === true){
    ...
    return [
        el(Popover, {
                onClick: () => handleShadowPanel(null),
                    ...
                    el('div', { role: 'group', 'aria-labelledby': 'components-menu-group-label-0' }, [
                        ...
                        el(VStack, { 'data-wp-c16t': 'true', 'data-wp-component': 'VStack', className: 'components-flex components-h-stack components-v-stack dd-f-a-a-de-1xpbaan e19lxcc00' }, [
                            ...
                            el('div', { className: 'components-color-list-picker' }, [
                                el(Button, { 
                                    onClick: () => handleShadowPanel(true),
                                    type: 'button', 
                    ...
                    el(
                        ...
                        el(
                            ColorPicker,
                            {
                                ...
                                onInput: () => setIsShowColorPickerDragging(true),
                                'data-wp-c16t': true,
